 ...
 * <PRE>
 * 1. JPQL를 사용한 테이블 전체 Select All
 * 2. JPQL를 사용한 조건절 Select All
 * 3. JPQL를 사용한 조건절 페이징
 * </PRE>
 * @author jae hyun
 */
public class JpqlPractice {
	...
	public static void main(String[] args) {
		...
		System.out.println(jpql.findAll());				// select All
		System.out.println(jpql.findAll_where());		// 조건부 select All
		System.out.println(jpql.findAll_paging());		// 페이징
	}
