...
import ch1_hellojpa.domain.Member;


/**
 * @Title <B>자바 ORM 표준 JPA 프로그래밍 기본 - Hello JPA</B>
 * <PRE>
 * 	- step-1 : JPA를 사용하여 Member class INSERT
 * 	- step-2 : JPA와 JPQL을 사용하여 MEMBER TABLE SELECT ALL
 * </PRE>
 * @author 1994d
 *
 */
public class JpaMain {
	public static void main(String[] args) {
		...
		*/ 
		...
		System.out.println("=================================== step-1. JPA를 사용하여 Member Entity를 INSERT ===================================");
		...
		*/
		...
		// jpa는 모든 작업단위마다 트랙잭션 시작과 끝을 정의해야함		-> 이 코드가 없어도 에러는 나지 않음 단, DB상 어떠한 변화도 일어나지 않는다.(조회시 x)
		...
		System.out.println("=================================== step-2. JPA의 JPQL을 사용하여 Member 테이블 Select ALL ===================================");
		/*
		...
		*/ 
		...
		System.out.println("Member table Select All : " + result);
		
		em.close();
		
		// 에플리케이션 종료시 EntityManagerFactory를 닫아야 한다.
		emf.close(); 	
	}
}
